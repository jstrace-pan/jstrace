...
// static
std::unique_ptr<HeadlessWebContentsImpl> HeadlessWebContentsImpl::Create(HeadlessWebContents::Builder* builder,
	...
	base::WrapUnique(new HeadlessWebContentsImpl(content::WebContents::Create(create_params),
...
HeadlessWebContents* HeadlessWebContents::Builder::Build() {
    // std::cout << "[jstrace @ src/headless/lib/browser/headless_web_contents_impl.cc] Initial_url is: " << initial_url_ << std::endl;
