...
#define BUILTIN(name)							\
	MUST_USE_RESULT static Object* Builtin_Impl_##name(BuiltinArguments args, \
							   Isolate* isolate); \
									\
	    V8_NOINLINE static Object* Builtin_Impl_Stats_##name(int args_length, Object** args_object, Isolate* isolate) { \
		...
		return Builtin_Impl_##name(args, isolate);		\
									...
									\
		MUST_USE_RESULT Object* Builtin_##name(int args_length, Object** args_object, Isolate* isolate) { \
