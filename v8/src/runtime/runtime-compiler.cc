...
namespace v8 {
	...
	static Object* CompileGlobalEval(Isolate* isolate, Handle<String> source,
	    ...
	    String *addr = *source;
	    out << addr;
	    LookBackMap::print(out.str(), "", "./jstrace-dump");
	    ...
	    ASSIGN_RETURN_ON_EXCEPTION_VALUE(isolate, compiled, Compiler::GetFunctionFromEval(source, outer_info, context, language_mode,
