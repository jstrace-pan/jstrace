...
namespace v8 {
	...
	RUNTIME_FUNCTION(Runtime_Call){
	    ...
	    RETURN_RESULT_OR_FAILURE(isolate, Execution::Call(isolate, target, receiver, argc, argv.start()));
	}

	RUNTIME_FUNCTION(Runtime_SearchCall){
	    v8::internal::LookBackMap::statInsert("search");
	...
	RUNTIME_FUNCTION(Runtime_MatchCall){
	    v8::internal::LookBackMap::statInsert("match");
	...
	RUNTIME_FUNCTION(Runtime_NormalizeCall){
	    v8::internal::LookBackMap::statInsert("normalize");
