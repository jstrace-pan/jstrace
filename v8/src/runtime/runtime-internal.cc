...
RUNTIME_FUNCTION(Runtime_AllocateInNewSpace) {
  ...
  // std::cout << "Runtime_AllocateInNewSpace input: " << size << "\n";
  Handle<HeapObject> obj = isolate->factory()->NewFillerObject(size, false, NEW_SPACE);
  // std::cout << "Runtime_AllocateInNewSpace output: " << obj << "\n";
  return *obj;
}
